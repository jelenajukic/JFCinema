...
.mj-column-per-50 { width:50% !important; max-width: 50%; }
    ...
    @media only screen and (max-width:480px) {
      ...
      <img
         height="auto" src="${image}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="200"
      />
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#555555;"
      >
        E-mail us jfcinema2019@gmail.com
      </div>
